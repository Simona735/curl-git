...
<!--    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#lectureDetail">-->
<!--        Launch demo modal-->
<!--    </button>-->

    <!-- Modal -->
    <div class="modal fade" id="lectureDetail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
